...
2. [Introducción a Discos Protoplanetarios (YouTube)](https://youtu.be/mGtMbqnMJ9E?si=QbJ3OQpiwt5nfSbX)
    * Video breve sobre qué son los discos protoplanetarios, cómo se forman y su desarrollo. 
3. [Astrofísica: ¿Qué es la Espectroscopía? (YouTube)](https://www.youtube.com/watch?v=rPIEZq-64sc)
    * Video sobre la espectroscopía en la astrofísica. Para este taller, solo cubriremos espectroscopía molecular. 
4. [Pandas Cheat Sheet (pdf)](https://pandas.pydata.org/Pandas_Cheat_Sheet.pdf)
    * Un PDF con atajos de Pandas. 
