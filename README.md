...
![InspiraSTEM2026 Participantes del Taller.](/imagenes/IMG_0716.jpeg)
...
Al finalizar el taller, los participantes podrán **reconocer espectros moleculares y los mecanismos físicos que los generan**. También habrán ganado **experiencia en la identificación de discos protoplanetarios y en la comprensión de cómo se forman los planetas**.
Además de la parte física, cada participante adquirirá **experiencia en el uso de herramientas programáticas para manipular conjuntos de datos** con técnicas y metodologías contemporáneas en astronomía.
A largo plazo, estos aprendizajes serán de utilidad en varios campos de STEM, como matemáticas, física, ciencias computacionales e incluso en aspectos de presentación profesional.
...
### Día 0 (Material Antecurso)
+ [Introducción a Jupyter Notebooks](https://github.com/mas-astro/inspirastem-ppd-CO/blob/main/00_antecurso/Intro_Jupyter_Notebooks.ipynb)
+ [Introducción a Discos Protoplanetarios (YouTube)](https://youtu.be/mGtMbqnMJ9E?si=QbJ3OQpiwt5nfSbX)
+ [Astrofísica: ¿Qué es la Espectroscopía? (YouTube)](https://www.youtube.com/watch?v=rPIEZq-64sc)
